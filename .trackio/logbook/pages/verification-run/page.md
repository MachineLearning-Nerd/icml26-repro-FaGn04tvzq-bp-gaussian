...
---
<!-- trackio-cell
{"type": "code", "id": "cell_cf4a090e10de", "created_at": "2026-07-21T14:04:08+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_bp.py"], "exit_code": 0, "duration_s": 0.179}
-->
````bash
$ .venv/bin/python repro/src/verify_bp.py
````

exit 0 · 0.2s


````python title=verify_bp.py
...
==============================================================================
CLAIM 1 (Theorem 4.1): chain beliefs Gaussianize with distance from the non-Gaussian prior
==============================================================================
  KL(belief||Gaussian) vs hop: [0.6117, 0.1743, 0.0667, 0.0327, 0.0212, 0.0173, 0.0161]
  KL decreases with distance (final 0.0161 << initial 0.6117) -> PASS

==============================================================================
CLAIM 2 (Theorem 4.4): tree-topology beliefs Gaussianize with depth
==============================================================================
